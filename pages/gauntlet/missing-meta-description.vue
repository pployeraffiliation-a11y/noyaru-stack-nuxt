...
useHead({
    ...
    htmlAttrs: { lang: 'fr' },
    meta: [
      { property: 'og:description', content: 'Découvrez le parcours d\'obstacles Noyaru, un défi unique et amusant.' },
      ...
      { name: 'twitter:description', content: 'Découvrez le parcours d\'obstacles Noyaru, un défi unique et amusant.' },
