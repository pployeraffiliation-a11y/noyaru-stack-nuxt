...
useHead({
    ...
    htmlAttrs: { lang: 'fr' },
    meta: [
      { name: 'description', content: 'Découvrez le parcours d'obstacles Noyaru, un défi unique et captivant.' },
      { name: 'viewport', content: 'width=device-width' },
      { property: 'og:type', content: 'article' },
      { property: 'og:title', content: 'Page de test du parcours d\'obstacles Noyaru' },
      { property: 'og:description', content: 'Découvrez le parcours d'obstacles Noyaru, un défi unique et captivant.' },
      ...
      { name: 'twitter:description', content: 'Découvrez le parcours d'obstacles Noyaru, un défi unique et captivant.' },
      { name: 'twitter:image', content: 'https://noyaru-stack-nuxt.netlify.app/og.png' }
    ],
    link: [
      { rel: 'canonical', href: 'https://noyaru-stack-nuxt.netlify.app/gauntlet/missing-meta-description/' }
    ],
});
</script>
