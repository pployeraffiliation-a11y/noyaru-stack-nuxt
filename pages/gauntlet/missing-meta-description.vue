...
useHead({
    ...
    htmlAttrs: { lang: 'fr' },
    meta: [
      { property: 'og:description', content: 'Cette page appartient au parcours d\'obstacles de la fixture. Elle sert a provoquer UNE anomalie et une seule.' },
      ...
      { name: 'twitter:description', content: 'Cette page appartient au parcours d\'obstacles de la fixture. Elle sert a provoquer UNE anomalie et une seule.' },
