...
useHead({
    title: 'Hreflang to Non-Canonical - Test du parcours d\'obstacles Noyaru',
    htmlAttrs: { lang: 'fr' },
    meta: [
      { name: 'viewport', content: 'width=device-width' },
      { name: 'description', content: 'Découvrez le parcours d obstacles Noyaru, où vous rencontrerez des défis uniques pour tester vos compétences dans des situations précises.' },
