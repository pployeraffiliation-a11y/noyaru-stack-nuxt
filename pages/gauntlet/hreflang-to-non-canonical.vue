...
useHead({
    ...
    meta: [
      ...
      { name: 'description', content: 'Découvrez le parcours d obstacles Noyaru, une expérience unique qui explore les défis rencontrés lors de la navigation sur le site.' },
