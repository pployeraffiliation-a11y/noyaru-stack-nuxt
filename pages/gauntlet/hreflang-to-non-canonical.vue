...
useHead({
    ...
    meta: [
      ...
      { name: 'description', content: 'Page de test du parcours d\'obstacles Noyaru, illustrant un cas spécifique pour le SEO.' },
      { property: 'og:type', content: 'article' },
      { property: 'og:title', content: 'Parcours d\'obstacles Noyaru - Page de test unique' },
      ...
      { name: 'twitter:title', content: 'Parcours d\'obstacles Noyaru - Page de test unique' },
      { name: 'twitter:description', content: 'Page de test du parcours d\'obstacles Noyaru, illustrant un cas spécifique pour le SEO.' },
    ...
    link: [
      ...
      { rel: 'alternate', hreflang: 'en', href: 'https://noyaru-stack-nuxt.netlify.app/gauntlet/canonical-relay/' }
    ],
});
</script>
