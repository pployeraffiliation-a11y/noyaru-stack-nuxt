...
useHead({
    title: 'Test hreflang vers une URL non canonique | Noyaru',
    htmlAttrs: { lang: 'fr' },
    meta: [
      { name: 'viewport', content: 'width=device-width' },
      { name: 'description', content: 'Page de test hreflang pointant vers une URL dont le canonical est different, afin de declencher cette anomalie precise lors du crawl.' },
