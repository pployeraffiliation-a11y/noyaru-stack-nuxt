...
useHead({
    title: 'Hreflang vers une page non canonique dans le parcours Noyaru',
    htmlAttrs: { lang: 'fr' },
    meta: [
      { name: 'viewport', content: 'width=device-width' },
      { name: 'description', content: 'Découvrez comment le parcours d obstacles Noyaru aborde le cas du hreflang vers une page non canonique, en soulignant ses spécificités.' },
