...
useHead({
    ...
    meta: [
      ...
      { name: 'description', content: 'Cette page traite des hreflangs pointant vers des pages non canoniques, illustrant un cas spécifique dans le parcours d\'obstacles.' },
