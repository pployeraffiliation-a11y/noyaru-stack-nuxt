...
useHead({
    ...
    meta: [
      ...
      { name: 'description', content: 'Page de test du parcours d\'obstacles Noyaru dediee au cas de la double barre (double slash) dans une URL de lien interne, pour verifier la detection au crawl.' },
