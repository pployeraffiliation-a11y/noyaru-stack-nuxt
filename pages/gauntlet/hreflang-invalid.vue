...
useHead({
    ...
    meta: [
      ...
      { name: 'description', content: 'Découvrez le parcours d\'obstacles Noyaru, qui présente des défis uniques et des situations précises à surmonter pour tester vos compétences.' },
