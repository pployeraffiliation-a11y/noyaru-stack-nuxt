...
useHead({
    ...
    meta: [
      ...
      { name: 'description', content: 'Page de test pour les annotations hreflang, démontrant une anomalie spécifique.' },
      { property: 'og:type', content: 'article' },
      { property: 'og:title', content: 'Page de test du parcours d\'obstacles Noyaru' },
      { property: 'og:description', content: 'Page de test pour les annotations hreflang, démontrant une anomalie spécifique.' },
      ...
      { name: 'twitter:description', content: 'Page de test pour les annotations hreflang, démontrant une anomalie spécifique.' },
