...
useHead({
    title: 'Page de test unique du parcours d\'obstacles Noyaru - Hreflang invalide',
    htmlAttrs: { lang: 'fr' },
    meta: [
      ...
      { property: 'og:title', content: 'Page de test unique du parcours d\'obstacles Noyaru - Hreflang invalide' },
      ...
      { name: 'twitter:title', content: 'Page de test unique du parcours d\'obstacles Noyaru - Hreflang invalide' },
