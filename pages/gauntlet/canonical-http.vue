<script setup>
// FAMILLE VISEE : canonical_from_https_to_http
// page servie en https, canonical en http.
useHead({
    ...
    link: [
      { rel: 'canonical', href: 'https://noyaru-stack-nuxt.netlify.app/gauntlet/canonical-http/' }
    ],
});
</script>
