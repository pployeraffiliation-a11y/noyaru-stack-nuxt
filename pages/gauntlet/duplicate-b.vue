...
useHead({
    title: 'Page de test du parcours d\'obstacles Noyaru - Duplicate B',
    htmlAttrs: { lang: 'fr' },
    meta: [
      ...
      { property: 'og:title', content: 'Page de test du parcours d\'obstacles Noyaru - Duplicate B' },
      ...
      { name: 'twitter:title', content: 'Page de test du parcours d\'obstacles Noyaru - Duplicate B' },
