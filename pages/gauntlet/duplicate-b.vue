...
useHead({
    title: 'Titre unique pour la page duplicate-b du parcours d\'obstacles',
    htmlAttrs: { lang: 'fr' },
    meta: [
      ...
      { property: 'og:title', content: 'Titre unique pour la page duplicate-b du parcours d\'obstacles' },
      ...
      { name: 'twitter:title', content: 'Titre unique pour la page duplicate-b du parcours d\'obstacles' },
