...
useHead({
    ...
    meta: [
      ...
      { property: 'og:title', content: 'Page de test du parcours d\'obstacles Noyaru - Double Slash' },
      ...
      { name: 'twitter:title', content: 'Page de test du parcours d\'obstacles Noyaru - Double Slash' },
