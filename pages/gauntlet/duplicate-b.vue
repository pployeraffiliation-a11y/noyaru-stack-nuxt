...
useHead({
    ...
    meta: [
      ...
      { property: 'og:title', content: 'Page de test unique pour le parcours d\'obstacles Noyaru' },
      ...
      { name: 'twitter:title', content: 'Page de test unique pour le parcours d\'obstacles Noyaru' },
