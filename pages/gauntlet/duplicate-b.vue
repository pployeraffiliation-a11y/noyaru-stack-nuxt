...
useHead({
    ...
    meta: [
      ...
      { name: 'description', content: 'Page B du test de doublons : cette fixture illustre le second exemplaire du parcours d obstacles avec une meta description desormais unique et distincte.' },
