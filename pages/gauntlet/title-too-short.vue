...
useHead({
    title: 'Test de performance des outils numériques en 2023 pour l\'efficacité',
    htmlAttrs: { lang: 'fr' },
    meta: [
      ...
      { property: 'og:url', content: 'https://noyaru-stack-nuxt.netlify.app/gauntlet/title-too-short/' },
    ...
    link: [
      { rel: 'canonical', href: 'https://noyaru-stack-nuxt.netlify.app/gauntlet/title-too-short/' }
    ],
});
</script>
