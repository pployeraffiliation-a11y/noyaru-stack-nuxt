...
useHead({
    ...
    meta: [
      ...
      { name: 'description', content: 'Page dédiée au parcours d\'obstacles duplicate a, illustrant une anomalie de duplication.' },
      { property: 'og:type', content: 'article' },
      { property: 'og:title', content: 'Test de parcours d\'obstacles : page duplicate A' },
      ...
      { name: 'twitter:title', content: 'Test de parcours d\'obstacles : page duplicate A' },
