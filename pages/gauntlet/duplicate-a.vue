...
useHead({
    title: 'Page A du parcours d obstacles Noyaru : titre unique',
    htmlAttrs: { lang: 'fr' },
    meta: [
      ...
      { property: 'og:title', content: 'Page A du parcours d obstacles Noyaru : titre unique' },
      ...
      { name: 'twitter:title', content: 'Page A du parcours d obstacles Noyaru : titre unique' },
