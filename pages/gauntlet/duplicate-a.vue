...
useHead({
    title: 'Test de doublons de titres dans le parcours d\'obstacles',
    htmlAttrs: { lang: 'fr' },
    meta: [
      { name: 'viewport', content: 'width=device-width' },
      { name: 'description', content: 'Page duplicate-a du parcours d obstacles, conçue pour tester les doublons de meta description.' },
      { property: 'og:type', content: 'article' },
      { property: 'og:title', content: 'Test de doublons de titres dans le parcours d\'obstacles' },
      ...
      { name: 'twitter:title', content: 'Test de doublons de titres dans le parcours d\'obstacles' },
