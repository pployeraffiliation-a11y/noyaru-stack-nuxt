...
useHead({
    ...
    meta: [
      ...
      { property: 'og:description', content: 'Découvrez le parcours d\'obstacles Noyaru, une expérience unique et captivante.' },
      ...
      { name: 'twitter:description', content: 'Découvrez le parcours d\'obstacles Noyaru, une expérience unique et captivante.' },
      { name: 'twitter:image', content: 'https://noyaru-stack-nuxt.netlify.app/og.png' }
    ],
    link: [
      { rel: 'canonical', href: 'https://noyaru-stack-nuxt.netlify.app/gauntlet/noindex-no-description/' }
    ],
});
</script>
...
<template>
  <main>
    ...
    <p>Cette page du parcours traite le cas « noindex no description ». Cette page appartient au parcours d'obstacles de la fixture. Elle sert a provoquer UNE anomalie et une seule.</p>
