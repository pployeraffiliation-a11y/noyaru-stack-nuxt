...
useHead({
    ...
    meta: [
      ...
      { property: 'og:description', content: 'Page de test du parcours d\'obstacles Noyaru servant à valider la détection des anomalies SEO.' },
      ...
      { name: 'twitter:description', content: 'Page de test du parcours d\'obstacles Noyaru servant à valider la détection des anomalies SEO.' },
