...
// aucun titre declare.
useHead({
    title: 'Parcours d obstacles - Anomalie de titre',
    htmlAttrs: { lang: 'fr' },
    meta: [
      ...
      { property: 'og:title', content: 'Parcours d obstacles - Anomalie de titre' },
      { property: 'og:description', content: 'Page du parcours d obstacles : elle est correcte partout sauf sur un point précis.' },
      { property: 'og:url', content: 'https://noyaru-stack-nuxt.netlify.app/gauntlet/missing-title/' },
      { property: 'og:image', content: 'https://noyaru-stack-nuxt.netlify.app/og.png' },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:title', content: 'Parcours d obstacles - Anomalie de titre' },
    ...
    link: [
      { rel: 'canonical', href: 'https://noyaru-stack-nuxt.netlify.app/gauntlet/missing-title/' }
    ],
});
</script>
