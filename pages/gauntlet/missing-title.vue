...
// aucun titre declare.
useHead({
    title: 'Parcours d\'obstacles - Titre manquant',
    htmlAttrs: { lang: 'fr' },
    meta: [
      { property: 'og:title', content: 'Parcours d\'obstacles - Titre manquant' },
      ...
      { name: 'twitter:title', content: 'Parcours d\'obstacles - Titre manquant' },
