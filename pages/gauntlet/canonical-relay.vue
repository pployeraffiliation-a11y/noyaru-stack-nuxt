...
<template>
  <main>
    <h1>Parcours d'obstacles : canonical relay</h1>
    <p>Cette page du parcours traite le cas « canonical relay ». Cette page appartient au parcours d'obstacles de la fixture. Elle sert a provoquer UNE anomalie et une seule.</p>
