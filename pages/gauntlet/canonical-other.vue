...
useHead({
    ...
    meta: [
      ...
      { property: 'og:url', content: 'https://noyaru-stack-nuxt.netlify.app/gauntlet/canonical-other/' },
...
<template>
  <main>
    <h1>Parcours d'obstacles : canonical other</h1>
    <p>Cette page du parcours traite le cas « canonical other ». Cette page appartient au parcours d'obstacles de la fixture. Elle sert a provoquer UNE anomalie et une seule.</p>
    <p><a href="/">Retour a l accueil</a></p>
    <img src="https://noyaru-stack-nuxt.netlify.app/og.png" alt="Image de la page d'accueil du parcours d'obstacles Noyaru">
  </main>
</template>
