...
useHead({
    title: 'Parcours d\'obstacles Noyaru - Hreflang sans lang HTML',
    ...
    meta: [
      ...
      { property: 'og:title', content: 'Parcours d\'obstacles Noyaru - Hreflang sans lang HTML' },
      ...
      { name: 'twitter:title', content: 'Parcours d\'obstacles Noyaru - Hreflang sans lang HTML' },
