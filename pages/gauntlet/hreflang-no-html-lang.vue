...
useHead({
    title: 'Parcours d\'obstacles Noyaru - Hreflang No HTML Lang',
    htmlAttrs: { lang: null },  // langue retiree : l'anomalie visee
    meta: [
      { name: 'viewport', content: 'width=device-width' },
      { name: 'description', content: 'Page de test du parcours d\'obstacles Noyaru, illustrant une anomalie spécifique.' },
      { property: 'og:type', content: 'article' },
      { property: 'og:title', content: 'Parcours d\'obstacles Noyaru - Hreflang No HTML Lang' },
      ...
      { name: 'twitter:title', content: 'Parcours d\'obstacles Noyaru - Hreflang No HTML Lang' },
